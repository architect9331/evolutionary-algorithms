...
void cec14_test_func(double *x, double *f, int nx, int mx, int func_num)
{
	...
	if (ini_flag == 0)
	{
		...
		/* Load Matrix M*/
		sprintf(FileName, "D:\\Genetic_Algorithm\\GA\\GA\\input_data\\M_%d_D%d.txt", func_num, nx);
		fpt = fopen(FileName, "r");
		if (fpt == NULL)
		{
			printf("\n Error: Cannot open input file for reading01 \n");
		}
		if (func_num < 23)
		{
		...
		/* Load shift_data */
		sprintf(FileName, "D:\\Genetic_Algorithm\\GA\\GA\\input_data\\shift_data_%d.txt", func_num);
		fpt = fopen(FileName, "r");
		if (fpt == NULL)
		{
			printf("\n Error: Cannot open input file for reading02 \n");
		}
		...
		{
			sprintf(FileName, "D:\\Genetic_Algorithm\\GA\\GA\\input_data\\shuffle_data_%d_D%d.txt", func_num, nx);
			fpt = fopen(FileName, "r");
			if (fpt == NULL)
			{
				printf("\n Error: Cannot open input file for reading03 \n");
			}
		...
		else if (func_num == 29 || func_num == 30)
		{
			...
			if (fpt == NULL)
			{
				printf("\n Error: Cannot open input file for reading04 \n");
			}
